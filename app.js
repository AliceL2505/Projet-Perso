...
// Catégories du profil "Lucie" : reprend les catégories par défaut, avec deux catégories
// supplémentaires pour les virements/paiements entre particuliers (WERO, Lydia, chèques...)
// détectés dans le relevé bancaire importé mais impossibles à classer avec certitude.
const LUCIE_CATEGORIES = [
  ...DEFAULT_CATEGORIES.map(c => ({ ...c })),
  { id: "virements_recus", name: "Virements reçus", type: "income", budget: 0 },
  { id: "virements_envoyes", name: "Virements envoyés", type: "expense", budget: 0 },
];
...
const LUCIE_SEED_TRANSACTIONS = [
  { date: "2026-01-02", amount: -69.98, categoryId: "voiture", note: "UBER * EATS PNL AMSTERDAM" },
  { date: "2026-01-02", amount: -26.78, categoryId: "courses", note: "POISSONNERIE DES HALLES" },
  { date: "2026-01-02", amount: -5.92, categoryId: "virements_envoyes", note: "PBP_ROUEN 92BOULOGNE-BILL" },
  { date: "2026-01-02", amount: -4.54, categoryId: "virements_envoyes", note: "PBP_ROUEN 92BOULOGNE-BILL" },
  { date: "2026-01-02", amount: -710, categoryId: "charges", note: "Loyer" },
  { date: "2026-01-03", amount: 41, categoryId: "virements_recus", note: "WERO MME JUSTINE MARTEI" },
  { date: "2026-01-03", amount: -105.46, categoryId: "courses", note: "CORA" },
  { date: "2026-01-03", amount: -65.87, categoryId: "amenagement", note: "IKEA" },
  { date: "2026-01-03", amount: -26.79, categoryId: "voiture", note: "UBER * EATS PNL AMSTERDAM" },
  { date: "2026-01-03", amount: -21.83, categoryId: "sante", note: "PHARMACIE DU CADRAN" },
  { date: "2026-01-03", amount: -19.5, categoryId: "restaurants", note: "SUSHI FR MANTES LA JO" },
  { date: "2026-01-03", amount: -8.99, categoryId: "plaisirs", note: "APPLE.COM/BILL IE 0805540003" },
  { date: "2026-01-03", amount: -6.49, categoryId: "plaisirs", note: "APPLE.COM/BILL IE 0805540003" },
  { date: "2026-01-03", amount: -3.3, categoryId: "restaurants", note: "FEUILLETTE FR GRAVIGNY" },
  { date: "2026-01-03", amount: -30.16, categoryId: "voiture", note: "CONNECT AUTOMOB78MANTES LA VIL" },
  { date: "2026-01-05", amount: -105.5, categoryId: "cadeaux", note: "Etsy.com*PhonocIE Dublin 1" },
  { date: "2026-01-05", amount: -10, categoryId: "plaisirs", note: "SnP*AY LOISIRS FR 94ORMESSON-S" },
  { date: "2026-01-05", amount: -114.96, categoryId: "vetements", note: "DECATHLON" },
  { date: "2026-01-05", amount: -1, categoryId: "restaurants", note: "2THELOO SAINT LFR PARIS" },
  { date: "2026-01-05", amount: -75.08, categoryId: "charges", note: "BPCE ASSURANCES" },
  { date: "2026-01-05", amount: -19.99, categoryId: "charges", note: "ORANGE" },
  { date: "2026-01-06", amount: -12.55, categoryId: "charges", note: "MACIF" },
  { date: "2026-01-07", amount: 317.13, categoryId: "virements_recus", note: "VIREMENT MLLE NURIS LUCIE" },
  { date: "2026-01-07", amount: -14.99, categoryId: "plaisirs", note: "NETFLIX COM 75PARIS" },
  { date: "2026-01-07", amount: -100, categoryId: "virements_envoyes", note: "BPCE Vie" },
  { date: "2026-01-08", amount: -73.38, categoryId: "voiture", note: "UBER * EATS PNL AMSTERDAM" },
  { date: "2026-01-08", amount: -0.09, categoryId: "charges", note: "FRAIS BANCAIRES" },
  { date: "2026-01-10", amount: -14.5, categoryId: "restaurants", note: "MY THAI" },
  { date: "2026-01-12", amount: -17, categoryId: "restaurants", note: "FEUILLETTE FR GRAVIGNY" },
  { date: "2026-01-12", amount: -18.21, categoryId: "plaisirs", note: "SPOTIFY" },
  { date: "2026-01-12", amount: -30.3, categoryId: "cadeaux", note: "AGAPANTHUS" },
  { date: "2026-01-12", amount: -110, categoryId: "virements_envoyes", note: "S.A.S. AMAND BALLUAIS" },
  { date: "2026-01-12", amount: -19.9, categoryId: "amenagement", note: "JARDINERIE FAVENNEC" },
  { date: "2026-01-12", amount: -2.67, categoryId: "virements_envoyes", note: "BPCE Vie" },
  { date: "2026-01-13", amount: -12.9, categoryId: "restaurants", note: "PAUL" },
  { date: "2026-01-13", amount: -5.1, categoryId: "voiture", note: "SERVICE NAVIGO FR 75PARIS" },
  { date: "2026-01-13", amount: -2.05, categoryId: "voiture", note: "SERVICE NAVIGO FR 75PARIS" },
  { date: "2026-01-13", amount: -2, categoryId: "vacances", note: "PASS CB DIJON FR DIJON" },
  { date: "2026-01-14", amount: 500, categoryId: "virements_recus", note: "VIREMENT MLLE NURIS LUCIE" },
  { date: "2026-01-14", amount: 20, categoryId: "virements_recus", note: "MME JUSTINE MARTEIL" },
  { date: "2026-01-14", amount: -36.25, categoryId: "virements_envoyes", note: "LYDIA SOLUTIONS" },
  { date: "2026-01-14", amount: -2, categoryId: "vacances", note: "PASS CB DIJON FR DIJON" },
  { date: "2026-01-14", amount: -7.1, categoryId: "voiture", note: "TD AUTOROUTES" },
  { date: "2026-01-14", amount: -103.87, categoryId: "vacances", note: "HOTELOP GRAND DIJON" },
  { date: "2026-01-14", amount: -29.8, categoryId: "voiture", note: "PEAGE AUTOROUTE" },
  { date: "2026-01-14", amount: -11.56, categoryId: "plaisirs", note: "CEZAM 21QUETIGNY" },
  { date: "2026-01-15", amount: -42.26, categoryId: "courses", note: "E.LECLERC FR PONT" },
  { date: "2026-01-15", amount: -6.99, categoryId: "plaisirs", note: "Disney Plus NL Hoofddorp" },
  { date: "2026-01-15", amount: -2, categoryId: "vacances", note: "PASS CB DIJON FR DIJON" },
  { date: "2026-01-15", amount: -159.5, categoryId: "restaurants", note: "GHO ANNEMASSE PORTE DE GENEVE" },
  { date: "2026-01-15", amount: -43.9, categoryId: "voiture", note: "TD AUTOROUTES" },
  { date: "2026-01-15", amount: -29.8, categoryId: "voiture", note: "PEAGE AUTOROUTE" },
  { date: "2026-01-16", amount: -18.16, categoryId: "restaurants", note: "DEL ARTE FR QUETI0080155" },
  { date: "2026-01-16", amount: -2.55, categoryId: "voiture", note: "SERVICE NAVIGO FR 75PARIS" },
  { date: "2026-01-16", amount: -2, categoryId: "vacances", note: "PASS CB DIJON FR DIJON" },
  { date: "2026-01-16", amount: -103.87, categoryId: "vacances", note: "HOTELOP GRAND DIJON" },
  { date: "2026-01-16", amount: -9.75, categoryId: "plaisirs", note: "CEZAM 21QUETIGNY" },
  { date: "2026-01-16", amount: -53.2, categoryId: "voiture", note: "BIP & GO" },
  { date: "2026-01-17", amount: -34, categoryId: "courses", note: "CORA" },
  { date: "2026-01-17", amount: -20.84, categoryId: "virements_envoyes", note: "LYDIA SOLUTIONS" },
  { date: "2026-01-17", amount: 500, categoryId: "virements_recus", note: "VIREMENT MLLE NURIS LUCIE" },
  { date: "2026-01-19", amount: -5.9, categoryId: "plaisirs", note: "1979 MEDIA FR FRANCE" },
  { date: "2026-01-19", amount: -72.22, categoryId: "courses", note: "E.LECLERC" },
  { date: "2026-01-19", amount: -426.57, categoryId: "voiture", note: "FCE BANK PLC" },
  { date: "2026-01-20", amount: 200, categoryId: "virements_recus", note: "VIREMENT MLLE NURIS LUCIE" },
  { date: "2026-01-21", amount: -45, categoryId: "cadeaux", note: "LA BOUQUETIERE FR EVREUX" },
  { date: "2026-01-21", amount: -108, categoryId: "charges", note: "EDF" },
  { date: "2026-01-23", amount: 72, categoryId: "virements_recus", note: "M NURIS LOIC" },
  { date: "2026-01-23", amount: 110, categoryId: "virements_recus", note: "MLLE BAYER INGRID" },
  { date: "2026-01-24", amount: -40.83, categoryId: "plaisirs", note: "LA BOUTIQUE DU COIFFEUR" },
  { date: "2026-01-24", amount: -28.31, categoryId: "courses", note: "CARREFOUR 27GUICHAINVILLE" },
  { date: "2026-01-26", amount: -32.37, categoryId: "courses", note: "CARREFOUR 27GUICHAINVILLE" },
  { date: "2026-01-27", amount: -16.99, categoryId: "plaisirs", note: "APPLE.COM/BILL IE CORK" },
  { date: "2026-01-29", amount: -19, categoryId: "plaisirs", note: "TYPOLOGY FR SAINT-OUEN" },
  { date: "2026-01-29", amount: 2545.73, categoryId: "salaire", note: "VIREMENT DELPHARM SERVICES" },
  { date: "2026-01-30", amount: -20, categoryId: "courses", note: "CORA" },
  { date: "2026-01-30", amount: 6.07, categoryId: "virements_recus", note: "VIREMENT POISSON LUCAS RE" },
  { date: "2026-01-30", amount: -15.99, categoryId: "charges", note: "ORANGE" },
  { date: "2026-01-30", amount: -250, categoryId: "virements_envoyes", note: "MLLE NURIS LUCIE" },
  { date: "2026-01-30", amount: -5.25, categoryId: "charges", note: "COTISATIONS BANCAIRES" },
  { date: "2026-01-31", amount: -68.85, categoryId: "plaisirs", note: "AMAZON" },
  { date: "2026-02-02", amount: -8.99, categoryId: "plaisirs", note: "APPLE.COM/BILL IE 0805540003" },
  { date: "2026-02-02", amount: -210, categoryId: "virements_envoyes", note: "ENVOI WERO CLAUDIA D" },
  { date: "2026-02-02", amount: -78.89, categoryId: "amenagement", note: "ADEO*LEROY MERLFR BUCHELAY" },
  { date: "2026-02-02", amount: -52.38, categoryId: "amenagement", note: "ADEO*LEROY MERLFR BUCHELAY" },
  { date: "2026-02-02", amount: -29.98, categoryId: "plaisirs", note: "AMAZON" },
  { date: "2026-02-02", amount: -19.99, categoryId: "charges", note: "ORANGE" },
  { date: "2026-02-02", amount: -710, categoryId: "charges", note: "Loyer" },
  { date: "2026-02-03", amount: -6.49, categoryId: "plaisirs", note: "APPLE.COM/BILL IE CORK" },
  { date: "2026-02-03", amount: -20.98, categoryId: "plaisirs", note: "NETFLIX" },
  { date: "2026-02-03", amount: 43, categoryId: "virements_recus", note: "VIREMENT MLLE ALICE LABRUNE" },
  { date: "2026-02-03", amount: 24, categoryId: "virements_recus", note: "VIREMENT MLLE ALICE LABRUNE" },
  { date: "2026-02-04", amount: 10, categoryId: "virements_recus", note: "VIREMENT MLLE DELEPINE CLAUDIA" },
  { date: "2026-02-05", amount: -10.95, categoryId: "plaisirs", note: "AMAZON" },
  { date: "2026-02-05", amount: -12.55, categoryId: "charges", note: "MACIF" },
  { date: "2026-02-05", amount: -100, categoryId: "virements_envoyes", note: "BPCE Vie" },
  { date: "2026-02-05", amount: -75.08, categoryId: "charges", note: "BPCE ASSURANCES" },
  { date: "2026-02-06", amount: -66.13, categoryId: "courses", note: "CORA" },
  { date: "2026-02-06", amount: -30, categoryId: "restaurants", note: "SumUp *JessicaFR Evreux" },
  { date: "2026-02-07", amount: -20, categoryId: "virements_envoyes", note: "ENVOI WERO SIMON R" },
  { date: "2026-02-07", amount: -30, categoryId: "virements_envoyes", note: "VIREMENT VERS ALICE LAB" },
  { date: "2026-02-09", amount: -7.4, categoryId: "plaisirs", note: "1979 MEDIA FR FRANCE" },
  { date: "2026-02-09", amount: -8.45, categoryId: "cadeaux", note: "Mol*GROUPE MONDETKeizersgracht" },
  { date: "2026-02-09", amount: -8, categoryId: "virements_envoyes", note: "ENVOI WERO ALAIN D" },
  { date: "2026-02-10", amount: -188.45, categoryId: "vacances", note: "HOTEL BOULOGNE 92BOULOGNE BILL" },
  { date: "2026-02-10", amount: -2.67, categoryId: "virements_envoyes", note: "BPCE Vie" },
  { date: "2026-02-11", amount: -1.8, categoryId: "virements_envoyes", note: "Swile FR Montpellier" },
  { date: "2026-02-12", amount: -18.21, categoryId: "plaisirs", note: "SpotifyFR SE STOCKHOLM" },
  { date: "2026-02-12", amount: -5, categoryId: "virements_envoyes", note: "Swile FR Montpellier" },
  { date: "2026-02-12", amount: -5, categoryId: "virements_envoyes", note: "Swile FR Montpellier" },
  { date: "2026-02-13", amount: -73.5, categoryId: "cadeaux", note: "LES LOUPS DANS LA BERGERIE" },
  { date: "2026-02-14", amount: -23.25, categoryId: "restaurants", note: "LE GARRISON FR EVREUX" },
  { date: "2026-02-14", amount: -32.03, categoryId: "voiture", note: "CERTAS ESSOF35893ROSNY" },
  { date: "2026-02-16", amount: -6.99, categoryId: "plaisirs", note: "Disney Plus NL Hoofddorp" },
  { date: "2026-02-17", amount: -36.34, categoryId: "courses", note: "CORA" },
  { date: "2026-02-17", amount: -80, categoryId: "voiture", note: "BIP & GO" },
  { date: "2026-02-17", amount: 50, categoryId: "remboursements", note: "VIREMENT APGIS" },
  { date: "2026-02-18", amount: -426.57, categoryId: "voiture", note: "FCE BANK PLC" },
  { date: "2026-02-20", amount: -43.3, categoryId: "amenagement", note: "JARDINERIE FAVENNEC" },
  { date: "2026-02-22", amount: 500, categoryId: "virements_recus", note: "Lucie Nuris" },
  { date: "2026-02-23", amount: -9.9, categoryId: "plaisirs", note: "1979 MEDIA FR FRANCE" },
  { date: "2026-02-23", amount: -33.85, categoryId: "sante", note: "DR GUILLEMAIN 27GAILLON" },
  { date: "2026-02-23", amount: -108, categoryId: "charges", note: "EDF" },
  { date: "2026-02-25", amount: -53.87, categoryId: "courses", note: "CORA" },
  { date: "2026-02-25", amount: -25, categoryId: "virements_envoyes", note: "VIREMENT VERS AURIANE S" },
  { date: "2026-02-27", amount: -65, categoryId: "restaurants", note: "SumUp *JessicaFR Evreux" },
  { date: "2026-02-27", amount: -16.99, categoryId: "plaisirs", note: "APPLE.COM/BILL IE CORK" },
  { date: "2026-02-27", amount: -1, categoryId: "virements_envoyes", note: "EFFIA CHU ROUENFR ROUEN" },
  { date: "2026-02-27", amount: 33.85, categoryId: "remboursements", note: "VIREMENT APGIS" },
  { date: "2026-02-27", amount: 2430.39, categoryId: "salaire", note: "VIREMENT DELPHARM SERVICES" },
  { date: "2026-02-27", amount: -250, categoryId: "virements_envoyes", note: "MLLE NURIS LUCIE" },
  { date: "2026-02-28", amount: -13.6, categoryId: "courses", note: "E.LECLERC" },
  { date: "2026-02-28", amount: -6.9, categoryId: "sante", note: "PHARMACIE DE CA27NORMANVILLE" },
  { date: "2026-03-01", amount: 20, categoryId: "virements_recus", note: "MLLE BAYER INGRID" },
  { date: "2026-03-02", amount: -6.49, categoryId: "plaisirs", note: "APPLE.COM/BILL IE 0805540003" },
  { date: "2026-03-02", amount: 6.07, categoryId: "virements_recus", note: "VIREMENT POISSON LUCAS RE" },
  { date: "2026-03-02", amount: -9.9, categoryId: "plaisirs", note: "1979 MEDIA FR FRANCE" },
  { date: "2026-03-02", amount: -25, categoryId: "voiture", note: "TOTAL" },
  { date: "2026-03-02", amount: -5.9, categoryId: "sante", note: "PHARMACIE DE CA27NORMANVILLE" },
  { date: "2026-03-02", amount: -15.99, categoryId: "charges", note: "ORANGE" },
  { date: "2026-03-02", amount: -710, categoryId: "charges", note: "Loyer" },
  { date: "2026-03-03", amount: -53.85, categoryId: "courses", note: "CORA" },
  { date: "2026-03-03", amount: -8.99, categoryId: "plaisirs", note: "APPLE.COM/BILL IE CORK" },
  { date: "2026-03-03", amount: -20.98, categoryId: "plaisirs", note: "NETFLIX" },
  { date: "2026-03-03", amount: -5.25, categoryId: "charges", note: "COTISATIONS BANCAIRES" },
  { date: "2026-03-04", amount: -224, categoryId: "voiture", note: "SNCF" },
  { date: "2026-03-04", amount: -61, categoryId: "voiture", note: "PPG*RAFFINEURS 75PARIS" },
  { date: "2026-03-04", amount: 112, categoryId: "virements_recus", note: "VIREMENT MLLE ALICE LABRUNE" },
  { date: "2026-03-05", amount: -13.5, categoryId: "virements_envoyes", note: "VIREMENT VERS MAXENCE R" },
  { date: "2026-03-05", amount: -100, categoryId: "virements_envoyes", note: "BPCE Vie" },
  { date: "2026-03-05", amount: -12.55, categoryId: "charges", note: "MACIF" },
  { date: "2026-03-05", amount: -75.08, categoryId: "charges", note: "BPCE ASSURANCES" },
  { date: "2026-03-06", amount: -36, categoryId: "restaurants", note: "DA LEONELLI FR EVREUX" },
  { date: "2026-03-06", amount: -19.99, categoryId: "charges", note: "ORANGE" },
  { date: "2026-03-07", amount: -4.7, categoryId: "restaurants", note: "LUCETTE CREPERIFR PARIS" },
  { date: "2026-03-07", amount: -2.55, categoryId: "voiture", note: "SERVICE NAVIGO FR 75PARIS" },
  { date: "2026-03-09", amount: 10, categoryId: "virements_recus", note: "WERO ML BERNARD CORALIE" },
  { date: "2026-03-09", amount: -8.5, categoryId: "virements_envoyes", note: "STATTELPAYBYPHO75PARIS" },
  { date: "2026-03-10", amount: -56.02, categoryId: "courses", note: "CORA" },
  { date: "2026-03-10", amount: -2.67, categoryId: "virements_envoyes", note: "BPCE Vie" },
  { date: "2026-03-11", amount: 20, categoryId: "virements_recus", note: "WERO GUILLAUME VANDENBU" },
  { date: "2026-03-11", amount: 10, categoryId: "virements_recus", note: "WERO MLE EMILIE CHARPEN" },
  { date: "2026-03-11", amount: -30.73, categoryId: "courses", note: "CARREFOUR 27GUICHAINVILLE" },
  { date: "2026-03-12", amount: -5, categoryId: "plaisirs", note: "L'OLYMPIA FR PARIS" },
  { date: "2026-03-12", amount: -18.21, categoryId: "plaisirs", note: "SPOTIFY" },
  { date: "2026-03-13", amount: -65, categoryId: "restaurants", note: "SumUp *JessicaFR Evreux" },
  { date: "2026-03-13", amount: -25.8, categoryId: "voiture", note: "PARCOFRANCE SERVICES" },
  { date: "2026-03-13", amount: -2.8, categoryId: "plaisirs", note: "MEATING CORNER FR 75 PARIS" },
  { date: "2026-03-13", amount: -5.15, categoryId: "restaurants", note: "O'BARADISE 27EVREUX" },
  { date: "2026-03-13", amount: 13, categoryId: "virements_recus", note: "VIREMENT MLLE ALICE LABRUNE" },
  { date: "2026-03-16", amount: -9.5, categoryId: "restaurants", note: "FEUILLETTE FR GRAVIGNY" },
  { date: "2026-03-16", amount: -25, categoryId: "voiture", note: "TOTAL" },
  { date: "2026-03-16", amount: -7.4, categoryId: "plaisirs", note: "1979 MEDIA FR FRANCE" },
  { date: "2026-03-16", amount: -6.99, categoryId: "plaisirs", note: "Disney Plus NL Hoofddorp" },
  { date: "2026-03-17", amount: -30.89, categoryId: "virements_envoyes", note: "T.I.R.R. FR ST ETIENNE D" },
  { date: "2026-03-17", amount: -12.7, categoryId: "voiture", note: "BIP & GO" },
  { date: "2026-03-18", amount: -7, categoryId: "plaisirs", note: "SEINE ZENITH" },
  { date: "2026-03-18", amount: -71.47, categoryId: "plaisirs", note: "LA BOUTIQUE DU COIFFEUR" },
  { date: "2026-03-18", amount: -65.07, categoryId: "plaisirs", note: "NEW LOISIRS & CULTURE" },
  { date: "2026-03-18", amount: -25, categoryId: "virements_envoyes", note: "SR ET ASSOCIES 27GUICHAINVILLE" },
  { date: "2026-03-18", amount: -10.45, categoryId: "courses", note: "CARREFOUR 27GUICHAINVILLE" },
  { date: "2026-03-18", amount: -426.57, categoryId: "voiture", note: "FCE BANK PLC" },
  { date: "2026-03-19", amount: 10, categoryId: "virements_recus", note: "WERO ZAKARIA TARIFIT" },
  { date: "2026-03-19", amount: -14.5, categoryId: "plaisirs", note: "V AND B" },
  { date: "2026-03-19", amount: -8.5, categoryId: "plaisirs", note: "V AND B" },
  { date: "2026-03-20", amount: -29.4, categoryId: "virements_envoyes", note: "FORF P.STAT WEB35RENNES" },
  { date: "2026-03-21", amount: -4.46, categoryId: "voiture", note: "UBER * EATS PNL AMSTERDAM" },
  { date: "2026-03-23", amount: 10, categoryId: "virements_recus", note: "WERO EDGAR YAOUANC" },
  { date: "2026-03-23", amount: -108, categoryId: "charges", note: "EDF" },
  { date: "2026-03-24", amount: 67, categoryId: "virements_recus", note: "Lucie Nuris" },
  { date: "2026-03-24", amount: -14.1, categoryId: "voiture", note: "STATION AVIA 02FRESNES EN TA" },
  { date: "2026-03-24", amount: -9.8, categoryId: "restaurants", note: "ACROPOLE" },
  { date: "2026-03-25", amount: 15, categoryId: "virements_recus", note: "WERO MORGANE PEREZ" },
  { date: "2026-03-25", amount: -299.94, categoryId: "virements_envoyes", note: "BLACK STORE 27EVREUX" },
  { date: "2026-03-25", amount: -10.2, categoryId: "voiture", note: "SANEF" },
  { date: "2026-03-26", amount: 10, categoryId: "virements_recus", note: "WERO LAURANNE GRUSELLE" },
  { date: "2026-03-26", amount: 10, categoryId: "virements_recus", note: "WERO STEPHANE PRENTOUT" },
  { date: "2026-03-26", amount: -19.2, categoryId: "voiture", note: "SOCIETE DES AUTOROUTES PARIS" },
  { date: "2026-03-26", amount: -10.2, categoryId: "voiture", note: "SANEF" },
  { date: "2026-03-27", amount: -16.99, categoryId: "plaisirs", note: "APPLE.COM/BILL IE 0805540003" },
  { date: "2026-03-27", amount: -10, categoryId: "virements_envoyes", note: "HR 27 ET HR" },
  { date: "2026-03-30", amount: -6.7, categoryId: "sante", note: "PHARMACIE DU CADRAN" },
  { date: "2026-03-30", amount: -170, categoryId: "virements_envoyes", note: "VIREMENT VERS PAUL LOUI" },
  { date: "2026-03-30", amount: 6.07, categoryId: "virements_recus", note: "VIREMENT POISSON LUCAS RE" },
  { date: "2026-03-30", amount: -4.12, categoryId: "restaurants", note: "LES GENS HEUREU76LE MESNIL ESN" },
  { date: "2026-03-30", amount: 50, categoryId: "virements_recus", note: "MLLE BAYER INGRID" },
  { date: "2026-03-30", amount: -15.99, categoryId: "charges", note: "ORANGE" },
  { date: "2026-03-30", amount: 2430.39, categoryId: "salaire", note: "VIREMENT DELPHARM SERVICES" },
  { date: "2026-03-31", amount: -24.93, categoryId: "courses", note: "CORA" },
  { date: "2026-03-31", amount: -30, categoryId: "courses", note: "INTERMARCHE 78FRENEUSE" },
  { date: "2026-03-31", amount: -5.25, categoryId: "charges", note: "COTISATIONS BANCAIRES" },
  { date: "2026-04-01", amount: -30, categoryId: "virements_envoyes", note: "VIREMENT VERS PAUL LOUI" },
  { date: "2026-04-01", amount: 30, categoryId: "virements_recus", note: "WERO ANTOINE ROUXEL" },
  { date: "2026-04-01", amount: -710, categoryId: "charges", note: "Loyer" },
  { date: "2026-04-01", amount: -250, categoryId: "virements_envoyes", note: "MLLE NURIS LUCIE" },
  { date: "2026-04-02", amount: -8.99, categoryId: "plaisirs", note: "APPLE.COM/BILL IE 0805540003" },
  { date: "2026-04-02", amount: -6.49, categoryId: "plaisirs", note: "APPLE.COM/BILL IE 0805540003" },
  { date: "2026-04-02", amount: -42.9, categoryId: "virements_envoyes", note: "VOU" },
  { date: "2026-04-03", amount: -20.98, categoryId: "plaisirs", note: "NETFLIX COM 75PARIS" },
  { date: "2026-04-04", amount: -7.99, categoryId: "plaisirs", note: "AMAZON" },
  { date: "2026-04-06", amount: 106, categoryId: "virements_recus", note: "MR OU MME NURIS" },
  { date: "2026-04-07", amount: -31.88, categoryId: "courses", note: "CARREFOUR DRIVE" },
  { date: "2026-04-07", amount: -29.55, categoryId: "courses", note: "ELECLERC" },
  { date: "2026-04-07", amount: -8.87, categoryId: "virements_envoyes", note: "EG RETAIL (FRANCE) SAS" },
  { date: "2026-04-07", amount: -106.93, categoryId: "charges", note: "JURATEL 50AGON-COUTAINV" },
  { date: "2026-04-07", amount: -24, categoryId: "courses", note: "CARREFOUR 75PARIS" },
  { date: "2026-04-07", amount: 500, categoryId: "virements_recus", note: "WERO MLE AURIANE SALOMO" },
  { date: "2026-04-07", amount: -18.25, categoryId: "charges", note: "MACIF" },
  { date: "2026-04-07", amount: -75.08, categoryId: "charges", note: "BPCE ASSURANCES" },
  { date: "2026-04-07", amount: -19.99, categoryId: "charges", note: "ORANGE" },
  { date: "2026-04-07", amount: -100, categoryId: "virements_envoyes", note: "BPCE Vie" },
  { date: "2026-04-08", amount: -1398, categoryId: "plaisirs", note: "AXS FRANCE SAS FR PARIS" },
  { date: "2026-04-08", amount: -9.9, categoryId: "plaisirs", note: "1979 MEDIA FR FRANCE" },
  { date: "2026-04-08", amount: 500, categoryId: "virements_recus", note: "WERO MLE AURIANE SALOMO" },
  { date: "2026-04-08", amount: 50, categoryId: "remboursements", note: "VIREMENT APGIS" },
  { date: "2026-04-10", amount: -1.2, categoryId: "virements_envoyes", note: "EFFIA CHU ROUEN76ROUEN" },
  { date: "2026-04-10", amount: 40.98, categoryId: "remboursements", note: "VIREMENT EDF CLT PART RBT SCT" },
  { date: "2026-04-11", amount: -22.67, categoryId: "courses", note: "CARREFOUR 27GUICHAINVILLE" },
  { date: "2026-04-13", amount: -33.94, categoryId: "amenagement", note: "TRUFFAUT" },
  { date: "2026-04-13", amount: 166, categoryId: "virements_recus", note: "WERO MLE AURIANE SALOMO" },
  { date: "2026-04-13", amount: -2.67, categoryId: "virements_envoyes", note: "BPCE Vie" },
  { date: "2026-04-14", amount: -29.9, categoryId: "amenagement", note: "JARDINERIE FAVENNEC" },
  { date: "2026-04-14", amount: -19, categoryId: "courses", note: "CORA" },
  { date: "2026-04-14", amount: -1.3, categoryId: "restaurants", note: "LEPENANT PATISSERIE BOULANGERIE" },
  { date: "2026-04-14", amount: -18.21, categoryId: "plaisirs", note: "SpotifyFR SE STOCKHOLM" },
  { date: "2026-04-15", amount: -65, categoryId: "restaurants", note: "SumUp *JessicaFR Evreux" },
  { date: "2026-04-15", amount: -6.99, categoryId: "plaisirs", note: "Disney Plus NL Hoofddorp" },
  { date: "2026-04-15", amount: -10.3, categoryId: "restaurants", note: "LES DELICES DE NORMANDIE" },
  { date: "2026-04-16", amount: -1.3, categoryId: "courses", note: "CARREFOUR 27GUICHAINVILLE" },
  { date: "2026-04-16", amount: -25.67, categoryId: "sante", note: "PHARMACIE EVREUX" },
  { date: "2026-04-17", amount: -36.7, categoryId: "voiture", note: "BIP & GO" },
  { date: "2026-04-18", amount: 8, categoryId: "virements_recus", note: "WERO MLLE COUPE PAULINE" },
  { date: "2026-04-20", amount: -30, categoryId: "voiture", note: "TOTAL" },
  { date: "2026-04-20", amount: -22.7, categoryId: "plaisirs", note: "ICE CREAM EVENT91MASSY" },
  { date: "2026-04-20", amount: -11.8, categoryId: "plaisirs", note: "ICE CREAM EVENT91MASSY" },
  { date: "2026-04-20", amount: -426.57, categoryId: "voiture", note: "FCE BANK PLC" },
  { date: "2026-04-21", amount: -5.1, categoryId: "voiture", note: "SERVICE NAVIGO 75PARIS 9" },
  { date: "2026-04-21", amount: 250, categoryId: "virements_recus", note: "VIREMENT MLLE NURIS LUCIE" },
  { date: "2026-04-23", amount: -6, categoryId: "vacances", note: "CASEO 27 27LOUVIERS" },
  { date: "2026-04-26", amount: 4, categoryId: "virements_recus", note: "WERO PAULINE GAONAC'H" },
  { date: "2026-04-27", amount: -16.99, categoryId: "plaisirs", note: "APPLE.COM/BILL IE 0805540003" },
  { date: "2026-04-28", amount: -64, categoryId: "voiture", note: "SNCF" },
  { date: "2026-04-28", amount: -62.9, categoryId: "restaurants", note: "LA TOQUE CUIVREE PLACE PAUL DOUMER" },
  { date: "2026-04-28", amount: -38, categoryId: "voiture", note: "SNCF" },
  { date: "2026-04-28", amount: -1.9, categoryId: "voiture", note: "TBM-VENTE LIGNE33BORDEAUX" },
  { date: "2026-04-29", amount: 2427.99, categoryId: "salaire", note: "VIREMENT DELPHARM SERVICES" },
  { date: "2026-04-30", amount: -45.23, categoryId: "amenagement", note: "SOSTRENE GRENE FR ROUEN" },
  { date: "2026-04-30", amount: -52.96, categoryId: "virements_envoyes", note: "DESJARDINS CLEO76TROUVILLE" },
  { date: "2026-04-30", amount: -12.9, categoryId: "voiture", note: "SOC ROUENNAISE DE STATIONNEMENT" },
  { date: "2026-04-30", amount: 6.07, categoryId: "virements_recus", note: "VIREMENT POISSON LUCAS RE" },
  { date: "2026-04-30", amount: -139, categoryId: "vetements", note: "BOCAGE" },
  { date: "2026-04-30", amount: -250, categoryId: "virements_envoyes", note: "MLLE NURIS LUCIE" },
  { date: "2026-04-30", amount: -5.25, categoryId: "charges", note: "COTISATIONS BANCAIRES" },
  { date: "2026-05-04", amount: -202.33, categoryId: "courses", note: "CORA" },
  { date: "2026-05-04", amount: -35, categoryId: "voiture", note: "TOTAL" },
  { date: "2026-05-04", amount: -19.88, categoryId: "restaurants", note: "MC DONALD'S" },
  { date: "2026-05-04", amount: 100, categoryId: "virements_recus", note: "VIREMENT M OU MME DOUBLIER MI" },
  { date: "2026-05-04", amount: -20.98, categoryId: "plaisirs", note: "NETFLIX COM 75PARIS" },
  { date: "2026-05-04", amount: -10, categoryId: "voiture", note: "CLEAN AUTO EVREUX" },
  { date: "2026-05-04", amount: -10, categoryId: "voiture", note: "CLEAN AUTO EVREUX" },
  { date: "2026-05-04", amount: -15.99, categoryId: "charges", note: "ORANGE" },
  { date: "2026-05-04", amount: -24.19, categoryId: "charges", note: "ORANGE" },
  { date: "2026-05-04", amount: -710, categoryId: "charges", note: "Loyer" },
  { date: "2026-05-05", amount: -15, categoryId: "virements_envoyes", note: "Leetchi SA 75Paris" },
  { date: "2026-05-05", amount: -100, categoryId: "virements_envoyes", note: "BPCE Vie" },
  { date: "2026-05-05", amount: -75.08, categoryId: "charges", note: "BPCE ASSURANCES" },
  { date: "2026-05-05", amount: -18.31, categoryId: "charges", note: "MACIF" },
  { date: "2026-05-09", amount: -65, categoryId: "restaurants", note: "SumUp *JessicaFR Evreux" },
  { date: "2026-05-09", amount: -15, categoryId: "courses", note: "CARREFOUR 27GUICHAINVILLE" },
  { date: "2026-05-10", amount: 50, categoryId: "virements_recus", note: "VIREMENT MLLE NURIS LUCIE" },
  { date: "2026-05-10", amount: -15, categoryId: "virements_envoyes", note: "VIREMENT VERS AURIANE S" },
  { date: "2026-05-11", amount: -119.29, categoryId: "virements_envoyes", note: "ENVOI WERO MARGOT F" },
  { date: "2026-05-11", amount: -64.59, categoryId: "vetements", note: "KIABI" },
  { date: "2026-05-11", amount: -49.6, categoryId: "sante", note: "PHARMACIE DU CADRAN" },
  { date: "2026-05-11", amount: -18.9, categoryId: "restaurants", note: "MC DONALD'S 78MORAINVILLIER" },
  { date: "2026-05-11", amount: -5.1, categoryId: "voiture", note: "PARC AUTO CATHEDRALE" },
  { date: "2026-05-11", amount: -2.93, categoryId: "courses", note: "ELECLERC" },
  { date: "2026-05-11", amount: 10, categoryId: "virements_recus", note: "WERO MLLE DELEPINE CLAU" },
  { date: "2026-05-11", amount: -21.31, categoryId: "voiture", note: "PETRO-EST 51SAINT-MARTIN-" },
  { date: "2026-05-12", amount: -18.21, categoryId: "plaisirs", note: "SpotifyFR SE STOCKHOLM" },
  { date: "2026-05-12", amount: -4.97, categoryId: "virements_envoyes", note: "VIREMENT VERS ABL GESTI" },
  { date: "2026-05-12", amount: -30, categoryId: "virements_envoyes", note: "ENVOI WERO ELISE H" },
  { date: "2026-05-12", amount: 500, categoryId: "virements_recus", note: "VIREMENT MLLE NURIS LUCIE" },
  { date: "2026-05-13", amount: -2.67, categoryId: "virements_envoyes", note: "BPCE Vie" },
  { date: "2026-05-13", amount: -65, categoryId: "voiture", note: "BIP & GO" },
  { date: "2026-05-14", amount: 115, categoryId: "virements_recus", note: "WERO MLLE COUPE PAULINE" },
  { date: "2026-05-14", amount: 50, categoryId: "remboursements", note: "VIREMENT APGIS" },
  { date: "2026-05-15", amount: -271, categoryId: "vetements", note: "JJ s House DE FRANKFURT" },
  { date: "2026-05-15", amount: -6.99, categoryId: "plaisirs", note: "Disney Plus NL Hoofddorp" },
  { date: "2026-05-15", amount: -40.43, categoryId: "plaisirs", note: "NEW LOISIRS & CULTURE" },
  { date: "2026-05-15", amount: -15.56, categoryId: "plaisirs", note: "LA BOUTIQUE DU COIFFEUR" },
  { date: "2026-05-15", amount: -8.5, categoryId: "virements_envoyes", note: "SR ET ASSOCIES 27GUICHAINVILLE" },
  { date: "2026-05-15", amount: -28.29, categoryId: "courses", note: "CARREFOUR 27GUICHAINVILLE" },
  { date: "2026-05-18", amount: -59.27, categoryId: "courses", note: "CORA" },
  { date: "2026-05-18", amount: -6, categoryId: "plaisirs", note: "PHOTOMATON" },
  { date: "2026-05-18", amount: -8.66, categoryId: "virements_envoyes", note: "ENVOI WERO AURIANE S" },
  { date: "2026-05-18", amount: -16, categoryId: "virements_envoyes", note: "ENVOI WERO ZELIA B" },
  { date: "2026-05-18", amount: 8.63, categoryId: "virements_recus", note: "MLLE BAYER INGRID" },
  { date: "2026-05-18", amount: -426.57, categoryId: "voiture", note: "FCE BANK PLC" },
  { date: "2026-05-19", amount: 9, categoryId: "virements_recus", note: "WERO MLLE DELEPINE CLAU" },
  { date: "2026-05-19", amount: 40, categoryId: "virements_recus", note: "MR OU MME NURIS" },
  { date: "2026-05-19", amount: 8, categoryId: "virements_recus", note: "Mlle ZELIA BRETON" },
  { date: "2026-05-20", amount: -108.2, categoryId: "virements_envoyes", note: "VET EVREUX" },
  { date: "2026-05-20", amount: -39.9, categoryId: "sante", note: "LABORATOIRE N.M.S." },
  { date: "2026-05-20", amount: -3.56, categoryId: "virements_envoyes", note: "PBP_ROUEN 92BOULOGNE-BILL" },
  { date: "2026-05-20", amount: -2.84, categoryId: "courses", note: "E.LECLERC" },
  { date: "2026-05-20", amount: -2, categoryId: "sante", note: "CLINIQUE MATHILDE" },
  { date: "2026-05-21", amount: 15, categoryId: "virements_recus", note: "WERO M DUTHOIT PAUL LOU" },
  { date: "2026-05-21", amount: -111.14, categoryId: "charges", note: "EDF" },
  { date: "2026-05-22", amount: -8.48, categoryId: "plaisirs", note: "NEW LOISIRS & CULTURE" },
  { date: "2026-05-22", amount: 10, categoryId: "virements_recus", note: "WERO MR GUILLOU DAVID O" },
  { date: "2026-05-27", amount: -16.99, categoryId: "plaisirs", note: "APPLE.COM/BILL IE 0805540003" },
  { date: "2026-05-27", amount: -20, categoryId: "virements_envoyes", note: "LYDIA SOLUTIONS" },
  { date: "2026-05-27", amount: -6, categoryId: "vacances", note: "CASEO 27 27LOUVIERS" },
  { date: "2026-05-27", amount: 10, categoryId: "virements_recus", note: "WERO MLE EMILIE CHARPEN" },
  { date: "2026-05-27", amount: 250, categoryId: "virements_recus", note: "VIREMENT MLLE NURIS LUCIE" },
  { date: "2026-05-27", amount: -65, categoryId: "restaurants", note: "SumUp *JessicaFR Evreux" },
  { date: "2026-05-28", amount: -15.88, categoryId: "restaurants", note: "MC DONALD'S" },
  { date: "2026-05-28", amount: -30, categoryId: "voiture", note: "TOTAL" },
  { date: "2026-05-28", amount: -52, categoryId: "voiture", note: "SNCF" },
  { date: "2026-05-29", amount: -34.25, categoryId: "vetements", note: "KIABI" },
  { date: "2026-05-29", amount: -2.3, categoryId: "virements_envoyes", note: "EFFIA CHU ROUEN76ROUEN" },
  { date: "2026-05-29", amount: 5, categoryId: "virements_recus", note: "WERO MORGANE PEREZ" },
  { date: "2026-05-29", amount: 15, categoryId: "virements_recus", note: "WERO LAURANNE GRUSELLE" },
  { date: "2026-05-30", amount: -5.25, categoryId: "charges", note: "COTISATIONS BANCAIRES" },
  { date: "2026-06-01", amount: -54.97, categoryId: "vetements", note: "Zalando PaymentDE Berlin" },
  { date: "2026-06-01", amount: -28.22, categoryId: "courses", note: "CORA" },
  { date: "2026-06-01", amount: -16.9, categoryId: "courses", note: "E.LECLERC" },
  { date: "2026-06-01", amount: -14.99, categoryId: "courses", note: "E.LECLERC" },
  { date: "2026-06-01", amount: -11, categoryId: "restaurants", note: "FEUILLETTE 27GRAVIGNY" },
  { date: "2026-06-01", amount: -7.08, categoryId: "courses", note: "CORA" },
  { date: "2026-06-01", amount: -5.1, categoryId: "voiture", note: "SERVICE NAVIGO 75PARIS 9" },
  { date: "2026-06-01", amount: 6.07, categoryId: "virements_recus", note: "VIREMENT POISSON LUCAS RE" },
  { date: "2026-06-01", amount: -15.99, categoryId: "charges", note: "ORANGE" },
  { date: "2026-06-01", amount: 2441.42, categoryId: "salaire", note: "VIREMENT DELPHARM SERVICES" },
  { date: "2026-06-02", amount: -9.88, categoryId: "virements_envoyes", note: "VIREMENT VERS ALICE LAB" },
  { date: "2026-06-02", amount: -8.7, categoryId: "restaurants", note: "RG GLACE 26 75PARIS" },
  { date: "2026-06-02", amount: -8, categoryId: "plaisirs", note: "FEDERATION FRANCAISE DE TENNIS" },
  { date: "2026-06-02", amount: -7.8, categoryId: "charges", note: "SODEXO" },
  { date: "2026-06-02", amount: -12, categoryId: "plaisirs", note: "FEDERATION FRANCAISE DE TENNIS" },
  { date: "2026-06-02", amount: -23.71, categoryId: "voiture", note: "CERTAS ESSOF35893ROSNY" },
  { date: "2026-06-02", amount: -250, categoryId: "virements_envoyes", note: "MLLE NURIS LUCIE" },
  { date: "2026-06-02", amount: -714.97, categoryId: "virements_envoyes", note: "ABL Gestion" },
  { date: "2026-06-03", amount: -27.99, categoryId: "courses", note: "CORA" },
  { date: "2026-06-03", amount: -20.98, categoryId: "plaisirs", note: "NETFLIX" },
  { date: "2026-06-03", amount: -5, categoryId: "virements_envoyes", note: "ABS AUTOMATIC BOISSONS SERVICES -" },
  { date: "2026-06-04", amount: -20.27, categoryId: "sante", note: "PHARMACIE DU CADRAN" },
  { date: "2026-06-05", amount: -153.32, categoryId: "vetements", note: "JJ's House DEDE ESCHBORNER" },
  { date: "2026-06-05", amount: -100, categoryId: "virements_envoyes", note: "BPCE Vie" },
  { date: "2026-06-05", amount: -18.31, categoryId: "charges", note: "MACIF" },
  { date: "2026-06-05", amount: -75.08, categoryId: "charges", note: "BPCE ASSURANCES" },
  { date: "2026-06-05", amount: -25.99, categoryId: "charges", note: "ORANGE" },
  { date: "2026-06-05", amount: 50, categoryId: "remboursements", note: "VIREMENT APGIS" },
  { date: "2026-06-07", amount: -40, categoryId: "virements_envoyes", note: "VIREMENT VERS AGNES NUR" },
  { date: "2026-06-08", amount: -5.25, categoryId: "virements_envoyes", note: "LOUISE EVREUX 27EVREUX" },
  { date: "2026-06-08", amount: -32.59, categoryId: "courses", note: "CORA" },
  { date: "2026-06-08", amount: -31, categoryId: "vetements", note: "KIABI" },
  { date: "2026-06-08", amount: -6.35, categoryId: "amenagement", note: "BRICORAMA" },
  { date: "2026-06-09", amount: -2.67, categoryId: "virements_envoyes", note: "BPCE Vie" },
  { date: "2026-06-10", amount: 26, categoryId: "virements_recus", note: "WERO ANTOINE ROUXEL" },
  { date: "2026-06-10", amount: 10, categoryId: "virements_recus", note: "WERO ML BERNARD CORALIE" },
  { date: "2026-06-11", amount: -65, categoryId: "restaurants", note: "SumUp *JessicaFR Evreux" },
  { date: "2026-06-11", amount: 147.01, categoryId: "vetements", note: "JJ s House DONT FRAIS:0,00E" },
  { date: "2026-06-11", amount: -18.24, categoryId: "virements_envoyes", note: "LA POSTE 75PARIS" },
  { date: "2026-06-11", amount: -19, categoryId: "virements_envoyes", note: "VIREMENT VERS AURIANE S" },
  { date: "2026-06-12", amount: -120, categoryId: "plaisirs", note: "WWW.PLANITY.COM7502 PARIS" },
  { date: "2026-06-12", amount: -18.21, categoryId: "plaisirs", note: "SPOTIFY" },
  { date: "2026-06-13", amount: -3.49, categoryId: "plaisirs", note: "APPLE.COM/BILL IE CORK" },
  { date: "2026-06-15", amount: -6.99, categoryId: "plaisirs", note: "Disney Plus NL Hoofddorp" },
  { date: "2026-06-15", amount: -40.3, categoryId: "voiture", note: "BIP & GO" },
  { date: "2026-06-17", amount: -27.79, categoryId: "courses", note: "CORA" },
  { date: "2026-06-17", amount: -5, categoryId: "virements_envoyes", note: "ABS AUTOMATIC BOISSONS SERVICES -" },
  { date: "2026-06-17", amount: -10, categoryId: "virements_envoyes", note: "ENVOI WERO CORALIE BERN" },
  { date: "2026-06-17", amount: 100, categoryId: "virements_recus", note: "DEPOT DE CHEQUES" },
  { date: "2026-06-18", amount: -6.8, categoryId: "vacances", note: "UTUROA 27LE VIEIL EVRE" },
  { date: "2026-06-18", amount: -426.57, categoryId: "voiture", note: "FCE BANK PLC" },
  { date: "2026-06-22", amount: -2.55, categoryId: "voiture", note: "SERVICE NAVIGO 75PARIS 9" },
  { date: "2026-06-22", amount: -3.99, categoryId: "plaisirs", note: "APPLE.COM/BILL IE 0805540003" },
  { date: "2026-06-22", amount: -33.03, categoryId: "courses", note: "CARREFOUR 27GUICHAINVILLE" },
  { date: "2026-06-22", amount: -111.14, categoryId: "charges", note: "EDF" },
  { date: "2026-06-23", amount: -1, categoryId: "restaurants", note: "2THELOO GARE DEFR PARIS" },
  { date: "2026-06-23", amount: -1, categoryId: "restaurants", note: "2THELOO GARE DEFR PARIS" },
  { date: "2026-06-23", amount: -34.5, categoryId: "restaurants", note: "IL RISTORANTE" },
  { date: "2026-06-23", amount: -14, categoryId: "restaurants", note: "STARBUCKS" },
  { date: "2026-06-23", amount: -2, categoryId: "virements_envoyes", note: "186940598760£1921Dijon£CUMUL" },
  { date: "2026-06-24", amount: -8.1, categoryId: "plaisirs", note: "RELAY" },
  { date: "2026-06-24", amount: -17.6, categoryId: "voiture", note: "PARCOFRANCE SERVICES" },
  { date: "2026-06-24", amount: -11.78, categoryId: "plaisirs", note: "CEZAM 21QUETIGNY" },
  { date: "2026-06-24", amount: -2, categoryId: "virements_envoyes", note: "667169545655£1921Dijon£CUMUL" },
  { date: "2026-06-24", amount: 30, categoryId: "virements_recus", note: "WERO ZAKARIA TARIFIT" },
  { date: "2026-06-24", amount: 5, categoryId: "virements_recus", note: "WERO STEPHANE PRENTOUT" },
  { date: "2026-06-24", amount: 5, categoryId: "virements_recus", note: "WERO MANON LEGER" },
  { date: "2026-06-24", amount: -103.87, categoryId: "vacances", note: "HOTELOP GRAND DIJON" },
  { date: "2026-06-25", amount: -30, categoryId: "virements_envoyes", note: "ENVOI WERO GUILLAUME V" },
  { date: "2026-06-25", amount: -67.8, categoryId: "virements_envoyes", note: "ENVOI WERO EMILIE C" },
  { date: "2026-06-25", amount: 500, categoryId: "virements_recus", note: "VIREMENT MLLE NURIS LUCIE" },
  { date: "2026-06-26", amount: -19.95, categoryId: "plaisirs", note: "NEW LOISIRS & CULTURE" },
  { date: "2026-06-26", amount: -0.99, categoryId: "amenagement", note: "GIFI" },
  { date: "2026-06-27", amount: -16.99, categoryId: "plaisirs", note: "APPLE.COM/BILL IE 0805540003" },
  { date: "2026-06-29", amount: -34.5, categoryId: "restaurants", note: "O'BARADISE 27EVREUX" },
  { date: "2026-06-29", amount: -10, categoryId: "virements_envoyes", note: "HR 27 ET HR" },
  { date: "2026-06-29", amount: 2431.13, categoryId: "salaire", note: "VIREMENT DELPHARM SERVICES" },
  { date: "2026-06-30", amount: -250, categoryId: "virements_envoyes", note: "MLLE NURIS LUCIE" },
  { date: "2026-06-30", amount: -83.88, categoryId: "courses", note: "CORA" },
  { date: "2026-06-30", amount: 6.07, categoryId: "virements_recus", note: "VIREMENT POISSON LUCAS RE" },
  { date: "2026-06-30", amount: -5.25, categoryId: "charges", note: "COTISATIONS BANCAIRES" },
  { date: "2026-07-01", amount: -65, categoryId: "restaurants", note: "SUMUP *JESSICAFR EVREUX" },
  { date: "2026-07-01", amount: -714.97, categoryId: "virements_envoyes", note: "ABL Gestion" },
  { date: "2026-07-01", amount: -250, categoryId: "virements_envoyes", note: "MLLE NURIS LUCIE" },
  { date: "2026-07-02", amount: -76.02, categoryId: "plaisirs", note: "LA BOUTIQUE DU COIFFEUR" },
  { date: "2026-07-02", amount: -63.47, categoryId: "vetements", note: "KIABI" },
  { date: "2026-07-02", amount: -15.99, categoryId: "charges", note: "ORANGE" },
  { date: "2026-07-03", amount: -20.98, categoryId: "plaisirs", note: "NETFLIX" },
...
function loadState(profileId) {
  ...
  try {
    ...
    if (raw) {
      ...
      // les opérations sans toucher aux catégories, projets ou épargne déjà personnalisés.
      if (profileId === "alice" && parsed._seedVersion !== SEED_DATA_VERSION) {
        parsed.transactions = SEED_TRANSACTIONS.map(t => ({ ...t, id: uid() }));
        parsed._seedVersion = SEED_DATA_VERSION;
        localStorage.setItem(key, JSON.stringify(parsed));
      }
      // Import du relevé bancaire réel dans le profil Lucie : remplace les anciennes
      // opérations fictives et complète les catégories manquantes, une seule fois.
      if (profileId === "lucie" && parsed._seedVersion !== LUCIE_SEED_DATA_VERSION) {
        parsed.transactions = LUCIE_SEED_TRANSACTIONS.map(t => ({ ...t, id: uid() }));
        parsed.categories = LUCIE_CATEGORIES.map(c => ({ ...c }));
        parsed._seedVersion = LUCIE_SEED_DATA_VERSION;
        localStorage.setItem(key, JSON.stringify(parsed));
      }
      return parsed;
    }
  ...
  // Autre profil (ex. Lucie) : historique réel importé depuis un relevé bancaire.
  const seeded = LUCIE_SEED_TRANSACTIONS.map(t => ({ ...t, id: uid() }));
  return {
    categories: LUCIE_CATEGORIES.map(c => ({ ...c })),
    transactions: seeded,
    projects: [],
    budgets: [],
    manualRecurring: [],
    ...
    credits: [],
    soldeCourant: { amount: 0, date: null },
    _seedVersion: LUCIE_SEED_DATA_VERSION,
  };
}
...
function renderHistory() {
  ...
  const txs = baseTxs
    ...
    // on l'inverse, puis on trie par date : à date égale, l'opération ajoutée le plus
    // récemment reste devant grâce à la stabilité du tri.
    .reverse()
    ...
    card.innerHTML = `
      <div class="project-top">
        ...
        <div class="project-actions">
          <button class="icon-btn" data-edit-project="${p.id}" aria-label="Modifier ${p.name}"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg></button>
...
document.getElementById("projectList").addEventListener("click", (e) => {
  ...
  if (editId) {
    ...
    document.getElementById("projectFormSubmitBtn").textContent = "Enregistrer les modifications";
    document.getElementById("projName").value = p.name;
    document.getElementById("projTarget").value = p.target;
    document.getElementById("projSaved").value = p.saved;
...
document.getElementById("openProjectModalCard").addEventListener("click", () => {
  ...
  document.getElementById("projectFormSubmitBtn").textContent = "Créer le projet";
  projectForm.reset();
});
...
projectForm.addEventListener("submit", (e) => {
  ...
  if (editingProjectId) {
    ...
    if (p) { p.name = name; p.target = target; p.saved = saved; p.date = date; p.note = note; }
    editingProjectId = null;
  } else {
